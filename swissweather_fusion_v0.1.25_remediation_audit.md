# SwissWeather Fusion — v0.1.24 / v0.1.25 Remediation Audit

**Release:** v0.1.23 → v0.1.25
...
left unchanged. Test suite 198 → **361 passing**. pyflakes **clean**
(the five long-standing unused-import warnings were also cleared).

> **v0.1.25** supersedes v0.1.24, which failed to load on upgrading
> installations. The defect content is identical; v0.1.25 fixes that
> failure and removes the structural hazard that caused it. See §7.1.
